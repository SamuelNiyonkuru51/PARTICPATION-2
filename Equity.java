...
public class Equity extends Company {
    ...
    public static void deposit() {
        ...
        boolean b2 = false;
        //CampA ct;
        ArrayList<Equity> ctAList = new ArrayList<>();
        ArrayList<Equity> histAList = new ArrayList<>();
        ListIterator<Equity> li = ctAList.listIterator();
        ListIterator<Equity.History> pi = histList.listIterator();
        for (Sacco ct : ctList) {
